...
const RequestHeader = ({ dir, data, showLoading }) => {
    ...
    const updateView = React.useCallback(() => {
        ...
        fetch('http://patent2net.edm.uqam.ca:5000/api/v1/requests/' + dir + "/interface", { 
            method: 'POST'
        })
    ...
    const updateRequest = React.useCallback(() => {
        fetch('http://patent2net.edm.uqam.ca:5000/api/v1/requests/' + dir+'/update', {
            method: 'POST'
        })
        .then(function(response) {
    ...
    const deleteRequest = React.useCallback(() => {
        fetch('http://patent2net.edm.uqam.ca:5000/api/v1/requests/' + dir, { 
            method: 'DELETE'
        })
        .then(function(response) {
            history.push('/app/requests')
